    ...
    getAboutData() {
      axios
        ...
        .then((response) => {
          ...
          //   companyHeadingEnglishcompanyImages,
          ...
          // this.aboutinfo = {
          //   clientContentArabic:                     clientContentArabic,
          //   clientContentEnglish:                    clientContentEnglish,
          //   clientHeadingArabic:                     clientHeadingArabic,
          //   clientHeadingEnglish:                    clientHeadingEnglish,
          //   clientImages:                            clientImages,
          //   companyContentArabic:                    "<p> Working </p>",
          //   companyContentEnglish:                   companyContentEnglish,
          //   companyHeadingArabic:                    companyHeadingArabic,
          //   companyHeadingEnglishcompanyImages:      companyHeadingEnglishcompanyImages,
          //   missionContentArabic:                    missionContentArabic,
          //   missionContentEnglish:                   missionContentEnglish,
          //   missionHeadingArabic:                    missionHeadingArabic,
          //   missionHeadingEnglish:                   missionHeadingEnglish,
          //   missionImages:                           missionImages,
          //   visionContentArabic:                     visionContentArabic,
          //   visionContentEnglish:                    visionContentEnglish,
          //   visionHeadingArabic:                     visionHeadingArabic,
          // };
        });
    },
    saveAboutData() {
      ...
      axios
        .patch(
          this.APIServer + "admin/updateAbout",
          {
            clientContentArabic: clientContentArabic,
          },
          {
        ...
        .then((response) => {
          if (response.data.status == true)
            console.log(response.datam, "log # 5552");
    ...
    saveAboutData2() {
      ...
      if (this.checkAlready == false) {
        ...
        newAbout.append(
          ...
          this.aboutinfo.companyHeadingEnglish
        );
        newAbout.append(
          "companyHeadingArabic",
          this.aboutinfo.companyHeadingArabic
        );
        newAbout.append(
          "companyContentEnglish",
          this.aboutinfo.companyContentEnglish
        );
        newAbout.append(
          "companyContentArabic",
          this.aboutinfo.companyContentArabic
        );
        newAbout.append(
          "missionHeadingEnglish",
          this.aboutinfo.missionHeadingEnglish
        );
        newAbout.append(
          "missionContentEnglish",
          this.aboutinfo.missionContentEnglish
        );
        newAbout.append(
          "missionHeadingArabic",
          this.aboutinfo.missionHeadingArabic
        );
        newAbout.append(
          "missionContentArabic",
          this.aboutinfo.missionContentArabic
        );
        newAbout.append(
          "visionHeadingEnglish",
          this.aboutinfo.visionHeadingEnglish
        );
        newAbout.append(
          "visionContentEnglish",
          this.aboutinfo.visionContentEnglish
        );
        newAbout.append(
          "visionHeadingArabic",
          this.aboutinfo.visionHeadingArabic
        );
        newAbout.append(
          "visionContentArabic",
          this.aboutinfo.visionContentArabic
        );
        newAbout.append(
          "clientHeadingEnglish",
          this.aboutinfo.clientHeadingEnglish
        );
        newAbout.append(
          "clientContentEnglish",
          this.aboutinfo.clientContentEnglish
        );
        newAbout.append(
          "clientContentArabic",
          this.aboutinfo.clientContentArabic
        );
        newAbout.append(
          "clientHeadingArabic",
          this.aboutinfo.clientHeadingArabic
        );
        ...
        axios
          ...
          .then((response) => {
            if (response.data.status == true) console.log(response.data);
            this.openNotificationWithIcon(
              "success",
              response.data.data,
              "bottomRight"
        ...
        console.log(newAbout, "fdsafsdfasfsdfsa");
        axios
